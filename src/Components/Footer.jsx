  ...
  return (
    <div className='w-full bg-darkblueLowVolume-bg border-t border-DarkGreen-br flex flex-col p-4 gap-6 md:p-8'>
      ...
      <div className='flex justify-between w-full max-w-[1700px] mx-auto p-4
        ...
        <div className='flex items-start justify-evenly w-full flex-wrap gap-10 max-sm:flex-col max-sm:items-center'>

          <section className='flex flex-col'>
            <h3 className='font-bold text-tiffany-txt! text-[clamp(20px,3vw,24px)] text-center'>About</h3>
            <Link className='text-muted-text'>About Us</Link>
            <Link className='text-muted-text'>Meet the Team</Link>
          </section>

          <section className='flex flex-col'>
            <h3 className='font-bold text-tiffany-txt! text-[clamp(20px,3vw,24px)] text-center'>Getting Started</h3>
            <Link className='text-muted-text'>Improve your account</Link>
            <Link className='text-muted-text'>Get premium access</Link>
            <Link className='text-muted-text'>Check top creators</Link>
          </section>

          <section className='flex flex-col'>
            <h3 className='font-bold text-tiffany-txt! text-[clamp(20px,3vw,24px)] text-center'>Social Media</h3>
            <p className='text-muted-text'>Follow us on social media to find out the latest updates on our progress : </p>
