...
import headerBackground from '../../assets/CorePicture.webp'
        ...
        >
            ...
            <div dir='ltr' className='relative z-10 w-full flex flex-col justify-between h-full gap-y-40
                ...
                <div className='flex flex-col gap-15
                    max-md:gap-0'>
                    <div className='flex gap-2 sm:flex-row text-[clamp(14px,4vw,16px)]
                        max-sm:flex-col
                        max-md:mt-10'>

                        <button className='bg-tiffany-bg text-darkest-blue-txt rounded-[10px] px-5 py-3 text-nowrap 
                        ...
                        <button
                            ...
                            className='group rounded-[10px] px-5 py-3 text-nowrap border-2 border-tiffany-bg text-white 
                    ...
                    <div className='w-full flex items-start gap-10
                        ...
                        <div className='flex items-start gap-2'>
                            ...
                            <div className='flex flex-col justify-between border-l-2 border-neutralGreen-br pl-2'>
                                <h3 className='font-bold'>{t("homeHeader.soloOnly")}</h3>
                        ...
                        <div className='flex items-start gap-2'>
                            ...
                            <div className='flex flex-col justify-between border-l-2 border-neutralGreen-br pl-2'>
                                <h3 className='font-bold'>{t("homeHeader.connect")}</h3>
                        ...
                        <div className='flex items-start gap-2'>
                            ...
                            <div className='flex flex-col justify-between border-l-2 border-neutralGreen-br pl-2'>
                                <h3 className='font-bold'>{t("homeHeader.earn")}</h3>
